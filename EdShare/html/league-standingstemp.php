                                    ...
                                    <div>
                                        <div class="row mx-1">
                                            ...
                                            <div
                                                ...
                                                <div><select id="UserRole" class="form-select">
                                                        <option value="WorldwideStandings" class="text-capitalize">
                                                            Worldwide Standings</option>
                                                        <option value="YourLeagueStandings" class="text-capitalize">Your
                                                            League Standings</option>
                                        ...
                                        <table
                                            ...
                                            <thead>
                                                <tr>
                                                    <th style="width: 25%;" tabindex="0" rowspan="1" colspan="1">Rank
                                                    </th>
                                                    <th style="width: 25%;" tabindex="0" rowspan="1" colspan="1">User
                                                    </th>
                                                    <th style="width: 25%;" tabindex="0" rowspan="1" colspan="1">Title
                                                    </th>
                                                    <th style="width: 25%;" tabindex="0" rowspan="1" colspan="1">Token
                                                        Score
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr class="odd">
                                                    <td><span class="fw-medium">#1</span></a></td>
                                                    <td>
                                                        <div class="d-flex justify-content-start align-items-center">

                                                            <div class="d-flex flex-column">
                                                                <span class="fw-medium">Hussein Charaf Eddine</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex justify-content-start align-items-center">
                                                            <div class="avatar-wrapper">
                                                                <div class="avatar avatar-sm me-2">
                                                                    <img src="../assets/badges/Immortal_8_Rank.png">
                                                                </div>
                                                            </div>
                                                            <div class="d-flex flex-column">
                                                                <span class="fw-medium">Immortal</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>10234</td>
                                                ...
                                                <tr class="even">
                                                    <td><span class="fw-medium">#2</span></a></td>
                                                    <td>
                                                        <div class="d-flex justify-content-start align-items-center">

                                                            <div class="d-flex flex-column">
                                                                <span class="fw-medium">Lara Tawbeh</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex justify-content-start align-items-center">
                                                            <div class="avatar-wrapper">
                                                                <div class="avatar avatar-sm me-2">
                                                                    <img src="../assets/badges/Ascendant_7_Rank.png">
                                                                </div>
                                                            </div>
                                                            <div class="d-flex flex-column">
                                                                <span class="fw-medium">Ascendant</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>10234</td>
